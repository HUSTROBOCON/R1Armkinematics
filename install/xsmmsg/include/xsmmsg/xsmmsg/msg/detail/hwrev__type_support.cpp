...
{
  new (message_memory) xsmmsg::msg::Hwrev(_init);
}

void Hwrev_fini_function(void * message_memory)
{
  auto typed_message = static_cast<xsmmsg::msg::Hwrev *>(message_memory);
  typed_message->~Hwrev();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Hwrev_message_member_array[1] = {
  {
    ...
    offsetof(xsmmsg::msg::Hwrev, tau),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Hwrev_message_members = {
  "xsmmsg::msg",  // message namespace
  "Hwrev",  // message name
  1,  // number of fields
  sizeof(xsmmsg::msg::Hwrev),
...
{
  return &::xsmmsg::msg::rosidl_typesupport_introspection_cpp::Hwrev_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xsmmsg, msg, Hwrev)() {
  return &::xsmmsg::msg::rosidl_typesupport_introspection_cpp::Hwrev_message_type_support_handle;
}
