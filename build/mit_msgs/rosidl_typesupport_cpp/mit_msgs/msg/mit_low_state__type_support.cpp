...
static const _MITLowState_type_support_symbol_names_t _MITLowState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mit_msgs, msg, MITLowState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mit_msgs, msg, MITLowState)),
  }
};
...
{
  return &::mit_msgs::msg::rosidl_typesupport_cpp::MITLowState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mit_msgs, msg, MITLowState)() {
  return get_message_type_support_handle<mit_msgs::msg::MITLowState>();
}
