...
#include "xsmmsg/msg/detail/hwrev__rosidl_typesupport_fastrtps_c.h"
...
#include "xsmmsg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Hwrev__ros_msg_type = xsmmsg__msg__Hwrev;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xsmmsg
size_t get_serialized_size_xsmmsg__msg__Hwrev(
  const void * untyped_ros_message,
...
static uint32_t _Hwrev__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xsmmsg__msg__Hwrev(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xsmmsg
size_t max_serialized_size_xsmmsg__msg__Hwrev(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xsmmsg__msg__Hwrev;
    is_plain =
      (
...
static size_t _Hwrev__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xsmmsg__msg__Hwrev(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xsmmsg, msg, Hwrev)() {
