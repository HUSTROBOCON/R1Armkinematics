...
#include "xsm_msg/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
using _Path__ros_msg_type = xsm_msg__msg__Path;
...
size_t get_serialized_size_xsm_msg__msg__Path(
  const void * untyped_ros_message,
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xsm_msg__msg__Path(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xsm_msg
size_t max_serialized_size_xsm_msg__msg__Path(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xsm_msg__msg__Path;
    is_plain =
      (
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xsm_msg__msg__Path(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xsm_msg, msg, Path)() {
