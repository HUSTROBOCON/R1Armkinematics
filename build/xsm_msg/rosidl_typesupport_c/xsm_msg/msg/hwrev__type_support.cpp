...
static const _Hwrev_type_support_symbol_names_t _Hwrev_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xsm_msg, msg, Hwrev)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xsm_msg, msg, Hwrev)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xsm_msg, msg, Hwrev)() {
  return &::xsm_msg::msg::rosidl_typesupport_c::Hwrev_message_type_support_handle;
}
