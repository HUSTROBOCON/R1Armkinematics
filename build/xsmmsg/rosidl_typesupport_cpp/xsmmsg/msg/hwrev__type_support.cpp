...
static const _Hwrev_type_support_symbol_names_t _Hwrev_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xsmmsg, msg, Hwrev)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xsmmsg, msg, Hwrev)),
  }
};
...
{
  return &::xsmmsg::msg::rosidl_typesupport_cpp::Hwrev_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xsmmsg, msg, Hwrev)() {
  return get_message_type_support_handle<xsmmsg::msg::Hwrev>();
}
