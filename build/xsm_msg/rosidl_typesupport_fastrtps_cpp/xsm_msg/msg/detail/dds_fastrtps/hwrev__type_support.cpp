...
#include "xsm_msg/msg/detail/hwrev__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const xsm_msg::msg::Hwrev & ros_message,
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xsm_msg::msg::Hwrev;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xsm_msg::msg::Hwrev *>(
    untyped_ros_message);
...
{
  return &xsm_msg::msg::typesupport_fastrtps_cpp::_Hwrev__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xsm_msg, msg, Hwrev)() {
  return &xsm_msg::msg::typesupport_fastrtps_cpp::_Hwrev__handle;
}
