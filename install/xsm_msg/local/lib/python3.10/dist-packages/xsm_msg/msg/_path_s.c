...
bool xsm_msg__msg__path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xsm_msg.msg._path.Path", full_classname_dest, 22) == 0);
  }
  xsm_msg__msg__Path * ros_message = _ros_message;
  {  // rows
...
PyObject * xsm_msg__msg__path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xsm_msg.msg._path");
