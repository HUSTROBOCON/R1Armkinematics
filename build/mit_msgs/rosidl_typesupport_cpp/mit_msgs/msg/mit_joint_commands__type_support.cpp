...
static const _MITJointCommands_type_support_symbol_names_t _MITJointCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mit_msgs, msg, MITJointCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mit_msgs, msg, MITJointCommands)),
  }
};
...
{
  return &::mit_msgs::msg::rosidl_typesupport_cpp::MITJointCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mit_msgs, msg, MITJointCommands)() {
  return get_message_type_support_handle<mit_msgs::msg::MITJointCommands>();
}
